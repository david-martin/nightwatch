  ...
  this.assert = function assert(passed, receivedValue, expectedValue, message, abortOnFailure) {
    ...
    if (!passed) {
      if (client.options.screenshots.onFail) {
        ...
        var fileName = 'FAIL_' + (message ? message.replace(/[^a-z0-9]/gi, '_') : '') + '_' + theBrowser + '_' + dateStamp + '.png';
        // e.g. FAIL_Timed_out_while_waiting_for_element___test__to_be_present_for_10000_milliseconds_firefox_Fri-Apr-03-2015-001327-GMT+0100.png
